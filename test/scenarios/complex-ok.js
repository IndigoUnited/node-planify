...
it('should run scenarios/complex-ok, verifying the order and the reporter integration', () => {
    ...
    .then(() => {
        ...
        expect(actions).to.eql([
            ...
            { label: 'Step 7 - Sync', action: 'step.start' },
            { label: 'Step 7 - Sync', action: 'step.write.stdout', str: 'step-7.visit\n' },
            { label: 'Step 7 - Sync', action: 'step.ok' },
            { label: 'Step 7 - Sync', action: 'step.finish' },
